...
def load_config_from_env() -> MovieAgentConfig:
    ...
    config = MovieAgentConfig(
        ...
        faiss_gpu_enabled=get_optional_env("FAISS_GPU_ENABLED", "false").lower() == "true",
        ...
        device=get_optional_env("DEVICE", default="auto"),  # "auto", "cpu", "cuda", "mps"
        force_cpu=get_optional_env("FORCE_CPU", "false").lower() == "true",
        log_hardware_info=get_optional_env("LOG_HARDWARE_INFO", "true").lower() == "true",
